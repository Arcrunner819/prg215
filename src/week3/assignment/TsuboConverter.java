...
public class TsuboConverter
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("If you would like to see a basic reference table, please press 3.");
        ...
        if(userInput == 1) {
          ...
          String formatTableLeft = "| %-15s | %-4d |%n ";
                    
          System.out.format("**---------------**--------**%n");
          System.out.format("| Total Sqft     || TSUBO  ||%n");
          System.out.format("**---------------**--------**%n");
          for (int i = 1; i < 10; i++) {
              tsuboResult = TSUBO * (double)i;
              DecimalFormat tsuboFormatted = new DecimalFormat("#####.00");
              String tsuboOut = tsuboFormatted.format(tsuboResult);
              System.out.format(formatTableLeft, tsuboOut, i);    
